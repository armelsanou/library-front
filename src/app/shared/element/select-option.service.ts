...
export class SelectOptionService {
  ...
  private static readonly COUNTRIES: Array<IOption> = [
    ...
    getCharacters(param): Array<IOption> {
        return this.cloneOptions(param);
    }

    loadCharacters(param): Observable<Array<IOption>> {
        return this.loadOptions(param);
    }

    getCharactersWithDisabled(param): Array<IOption> {
        const characters: Array<IOption> = this.cloneOptions(param);
